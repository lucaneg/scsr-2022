...
public class WrappedIntervalsTest {

    @Test
    public void testSigns() throws ParsingException, AnalysisException {
        Program program = IMPFrontend.processFile("inputs/wrapped-intervals.imp");
        ...
        conf.setAbstractState(
                new SimpleAbstractState<>(
                        ...
                        new ValueEnvironment<>(new WrappedIntervals()), // THIS IS THE VALUE DOMAIN
